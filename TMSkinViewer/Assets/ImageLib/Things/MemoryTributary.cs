...
namespace UsefulThings
{
    ...
    /// <summary>
    ///     MemoryTributary is a re-implementation of MemoryTributary that uses a dynamic list of byte arrays as a backing
    ///     store, instead of a single byte array, the allocation
