...
namespace UsefulThings
{
    ...
    /// <summary>
    ///     This Collection wraps its index such that if length = 2, and the call is list[6], the collection would return the
    ///     first element.
    ...
    public class WrappingCollection < T > : ICollection < T >, IList < T >
    {
        ...
        private List < T > UnderlyingCollection = null;

        /// <summary>
        ///     Number of elements in collection.
        /// </summary>
        public int Count => UnderlyingCollection != null ? UnderlyingCollection.Count : -1;
        ...
        {
            get => UnderlyingCollection[WrapIndex( index )];
            set => UnderlyingCollection[WrapIndex( index )] = value;
        }
        ...
        /// <summary>
        ///     Wraps the index using the mod operator to determine if the index is larger than the list and alters it so it's in
        ///     range.
        /// </summary>
