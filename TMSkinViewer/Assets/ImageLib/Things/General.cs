...
namespace UsefulThings
{
    ...
    public static class General
    {
        ...
        public static class StreamBitConverter
        {
            ...
            public static uint ToUInt32( Stream stream, int offset )
            {
                ...
                uint retval = BitConverter.ToUInt32( fourBytes, 0 );
        ...
        private static string[] CapitalExcluded = new string[] { "in", "the", "at" };
        ...
        public static MemoryStream CompressStream(
        ...
        /// <summary>
        ///     Extends on substring functionality to extract string between two other strings. e.g. ExtractString("indigo", "in",
        ///     "go") == "di"
        /// </summary>
        ...
        /// <summary>
        ///     Extends on substring functionality to extract string between a delimiter. e.g. ExtractString("I like #snuffles# and
        ///     things", "#") == "snuffles"
        /// </summary>
        /// <param name="str">String to extract from.</param>
        ...
        public static string FindValidNewFileName( string baseName )
        {
            if ( !baseName.isFile() )
            {
                throw new ArgumentOutOfRangeException(
                                                      $"{nameof( baseName )} must be a testable file path, not a directory path."
                                                     );
            }
        ...
        public static byte[] GetExternalData( string file, int retries = 20, int OnFailureSleepTime = 300 )
        {
            for ( int i = 0; i < retries; i++ )
            {
                ...
                catch ( IOException e )
                {
                    ...
                    Thread.Sleep( OnFailureSleepTime );
        ...
        public static string GetFullPathWithoutExtension( string fullPath )
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
                                                      $"{nameof( fullPath )} must be a testable file path, not a directory path."
                                                     );
            }
        ...
        private static void CapitaliseWord( string word, StringBuilder destination )
        {
            if ( string.IsNullOrEmpty( word ) )
            {
                return;
