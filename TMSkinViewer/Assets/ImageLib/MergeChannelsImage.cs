...
//         /// </summary>
//         public bool HasAssignedChannel => IsAlpha || IsRed || IsBlue || IsGreen;
//
//         /// <summary>
...
//             FilePath = mainPath;
//
//             ImageEngineImage img = new ImageEngineImage( mainPath );
//
//             {
//                 Width = img.Width;
//                 Height = img.Height;
...
//         {
//             foreach ( MergeChannelsImage channel in channels )
//             {
