...
namespace CSharpImageLibrary.DDS
{
    ...
    public static class BC6
    {
        ...
        internal struct INTColour
        {
            ...
            private static float IntToFloatIsh( int input, bool isSigned )
            {
                ushort outVal;
            ...
            private const uint FloatMantissasMask = 0x03FF;
            private const uint FloatExponentMask = 0x7C00;
            private const uint FloatSignMask = 0x8000;

            private static int F16ToInt( ushort halfFloat, bool isSigned )
            {
                int result, s;
            ...
            private static unsafe float HalfFloatToFloat( ushort halfFloat )
            {
            ...
            private static unsafe ushort FloatToHalf( float value )
            {
                uint val = *( uint* )&value;
        ...
        private static List < List < ModeDescriptor > > ms_aDesc = new List < List < ModeDescriptor > >()
                                                                   {
                                                                       // Mode 1 (0x00) - 10 5 5 5
                                                                       new List < ModeDescriptor >()
                                                                       {
                                                                           new ModeDescriptor( EField.M, 0 ),
                                                                           new ModeDescriptor( EField.M, 1 ),
                                                                           new ModeDescriptor( EField.GY, 4 ),
                                                                           new ModeDescriptor( EField.BY, 4 ),
                                                                           new ModeDescriptor( EField.BZ, 4 ),
                                                                           new ModeDescriptor( EField.RW, 0 ),
                                                                           new ModeDescriptor( EField.RW, 1 ),
                                                                           new ModeDescriptor( EField.RW, 2 ),
                                                                           new ModeDescriptor( EField.RW, 3 ),
                                                                           new ModeDescriptor( EField.RW, 4 ),
                                                                           new ModeDescriptor( EField.RW, 5 ),
                                                                           new ModeDescriptor( EField.RW, 6 ),
                                                                           new ModeDescriptor( EField.RW, 7 ),
                                                                           new ModeDescriptor( EField.RW, 8 ),
                                                                           new ModeDescriptor( EField.RW, 9 ),
                                                                           new ModeDescriptor( EField.GW, 0 ),
                                                                           new ModeDescriptor( EField.GW, 1 ),
                                                                           new ModeDescriptor( EField.GW, 2 ),
                                                                           new ModeDescriptor( EField.GW, 3 ),
                                                                           new ModeDescriptor( EField.GW, 4 ),
                                                                           new ModeDescriptor( EField.GW, 5 ),
                                                                           new ModeDescriptor( EField.GW, 6 ),
                                                                           new ModeDescriptor( EField.GW, 7 ),
                                                                           new ModeDescriptor( EField.GW, 8 ),
                                                                           new ModeDescriptor( EField.GW, 9 ),
                                                                           new ModeDescriptor( EField.BW, 0 ),
                                                                           new ModeDescriptor( EField.BW, 1 ),
                                                                           new ModeDescriptor( EField.BW, 2 ),
                                                                           new ModeDescriptor( EField.BW, 3 ),
                                                                           new ModeDescriptor( EField.BW, 4 ),
                                                                           new ModeDescriptor( EField.BW, 5 ),
                                                                           new ModeDescriptor( EField.BW, 6 ),
                                                                           new ModeDescriptor( EField.BW, 7 ),
                                                                           new ModeDescriptor( EField.BW, 8 ),
                                                                           new ModeDescriptor( EField.BW, 9 ),
                                                                           new ModeDescriptor( EField.RX, 0 ),
                                                                           new ModeDescriptor( EField.RX, 1 ),
                                                                           new ModeDescriptor( EField.RX, 2 ),
                                                                           new ModeDescriptor( EField.RX, 3 ),
                                                                           new ModeDescriptor( EField.RX, 4 ),
                                                                           new ModeDescriptor( EField.GZ, 4 ),
                                                                           new ModeDescriptor( EField.GY, 0 ),
                                                                           new ModeDescriptor( EField.GY, 1 ),
                                                                           new ModeDescriptor( EField.GY, 2 ),
                                                                           new ModeDescriptor( EField.GY, 3 ),
                                                                           new ModeDescriptor( EField.GX, 0 ),
                                                                           new ModeDescriptor( EField.GX, 1 ),
                                                                           new ModeDescriptor( EField.GX, 2 ),
                                                                           new ModeDescriptor( EField.GX, 3 ),
                                                                           new ModeDescriptor( EField.GX, 4 ),
                                                                           new ModeDescriptor( EField.BZ, 0 ),
                                                                           new ModeDescriptor( EField.GZ, 0 ),
                                                                           new ModeDescriptor( EField.GZ, 1 ),
                                                                           new ModeDescriptor( EField.GZ, 2 ),
                                                                           new ModeDescriptor( EField.GZ, 3 ),
                                                                           new ModeDescriptor( EField.BX, 0 ),
                                                                           new ModeDescriptor( EField.BX, 1 ),
                                                                           new ModeDescriptor( EField.BX, 2 ),
                                                                           new ModeDescriptor( EField.BX, 3 ),
                                                                           new ModeDescriptor( EField.BX, 4 ),
                                                                           new ModeDescriptor( EField.BZ, 1 ),
                                                                           new ModeDescriptor( EField.BY, 0 ),
                                                                           new ModeDescriptor( EField.BY, 1 ),
                                                                           new ModeDescriptor( EField.BY, 2 ),
                                                                           new ModeDescriptor( EField.BY, 3 ),
                                                                           new ModeDescriptor( EField.RY, 0 ),
                                                                           new ModeDescriptor( EField.RY, 1 ),
                                                                           new ModeDescriptor( EField.RY, 2 ),
                                                                           new ModeDescriptor( EField.RY, 3 ),
                                                                           new ModeDescriptor( EField.RY, 4 ),
                                                                           new ModeDescriptor( EField.BZ, 2 ),
                                                                           new ModeDescriptor( EField.RZ, 0 ),
                                                                           new ModeDescriptor( EField.RZ, 1 ),
                                                                           new ModeDescriptor( EField.RZ, 2 ),
                                                                           new ModeDescriptor( EField.RZ, 3 ),
                                                                           new ModeDescriptor( EField.RZ, 4 ),
                                                                           new ModeDescriptor( EField.BZ, 3 ),
                                                                           new ModeDescriptor( EField.D, 0 ),
                                                                           new ModeDescriptor( EField.D, 1 ),
                                                                           new ModeDescriptor( EField.D, 2 ),
                                                                           new ModeDescriptor( EField.D, 3 ),
                                                                           new ModeDescriptor( EField.D, 4 ),
                                                                       },
                                                                       ...
                                                                       new List < ModeDescriptor >()
                                                                       {
                                                                           new ModeDescriptor( EField.M, 0 ),
                                                                           new ModeDescriptor( EField.M, 1 ),
                                                                           new ModeDescriptor( EField.GY, 5 ),
                                                                           new ModeDescriptor( EField.GZ, 4 ),
                                                                           new ModeDescriptor( EField.GZ, 5 ),
                                                                           new ModeDescriptor( EField.RW, 0 ),
                                                                           new ModeDescriptor( EField.RW, 1 ),
                                                                           new ModeDescriptor( EField.RW, 2 ),
                                                                           new ModeDescriptor( EField.RW, 3 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.GW, 5 ),
                                                                           new ModeDescriptor( EField.GW, 6 ),
                                                                           new ModeDescriptor( EField.BY, 5 ),
                                                                           new ModeDescriptor( EField.BZ, 2 ),
                                                                           new ModeDescriptor( EField.GY, 4 ),
                                                                           new ModeDescriptor( EField.BW, 0 ),
                                                                           new ModeDescriptor( EField.BW, 1 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.BW, 6 ),
                                                                           new ModeDescriptor( EField.BZ, 3 ),
                                                                           new ModeDescriptor( EField.BZ, 5 ),
                                                                           new ModeDescriptor( EField.BZ, 4 ),
                                                                           new ModeDescriptor( EField.RX, 0 ),
                                                                           new ModeDescriptor( EField.RX, 1 ),
                                                                           new ModeDescriptor( EField.RX, 2 ),
                                                                           new ModeDescriptor( EField.RX, 3 ),
                                                                           new ModeDescriptor( EField.RX, 4 ),
                                                                           new ModeDescriptor( EField.RX, 5 ),
                                                                           new ModeDescriptor( EField.GY, 0 ),
                                                                           new ModeDescriptor( EField.GY, 1 ),
                                                                           new ModeDescriptor( EField.GY, 2 ),
                                                                           new ModeDescriptor( EField.GY, 3 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.GX, 3 ),
                                                                           new ModeDescriptor( EField.GX, 4 ),
                                                                           new ModeDescriptor( EField.GX, 5 ),
                                                                           new ModeDescriptor( EField.GZ, 0 ),
                                                                           new ModeDescriptor( EField.GZ, 1 ),
                                                                           new ModeDescriptor( EField.GZ, 2 ),
                                                                           new ModeDescriptor( EField.GZ, 3 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.BX, 3 ),
                                                                           new ModeDescriptor( EField.BX, 4 ),
                                                                           new ModeDescriptor( EField.BX, 5 ),
                                                                           new ModeDescriptor( EField.BY, 0 ),
                                                                           new ModeDescriptor( EField.BY, 1 ),
                                                                           new ModeDescriptor( EField.BY, 2 ),
                                                                           new ModeDescriptor( EField.BY, 3 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.RY, 3 ),
                                                                           new ModeDescriptor( EField.RY, 4 ),
                                                                           new ModeDescriptor( EField.RY, 5 ),
                                                                           new ModeDescriptor( EField.RZ, 0 ),
                                                                           new ModeDescriptor( EField.RZ, 1 ),
                                                                           new ModeDescriptor( EField.RZ, 2 ),
                                                                           new ModeDescriptor( EField.RZ, 3 ),
                                                                           new ModeDescriptor( EField.RZ, 4 ),
                                                                           new ModeDescriptor( EField.RZ, 5 ),
                                                                           new ModeDescriptor( EField.D, 0 ),
                                                                           new ModeDescriptor( EField.D, 1 ),
                                                                           new ModeDescriptor( EField.D, 2 ),
                                                                           new ModeDescriptor( EField.D, 3 ),
                                                                       ...
                                                                       new List < ModeDescriptor >()
                                                                       {
                                                                           new ModeDescriptor( EField.M, 0 ),
                                                                           new ModeDescriptor( EField.M, 1 ),
                                                                           new ModeDescriptor( EField.M, 2 ),
                                                                           new ModeDescriptor( EField.M, 3 ),
                                                                           new ModeDescriptor( EField.M, 4 ),
                                                                           new ModeDescriptor( EField.RW, 0 ),
                                                                           new ModeDescriptor( EField.RW, 1 ),
                                                                           new ModeDescriptor( EField.RW, 2 ),
                                                                           new ModeDescriptor( EField.RW, 3 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.RX, 3 ),
                                                                           new ModeDescriptor( EField.RX, 4 ),
                                                                           new ModeDescriptor( EField.RW, 10 ),
                                                                           new ModeDescriptor( EField.GY, 0 ),
                                                                           new ModeDescriptor( EField.GY, 1 ),
                                                                           new ModeDescriptor( EField.GY, 2 ),
                                                                           new ModeDescriptor( EField.GY, 3 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.GX, 2 ),
                                                                           new ModeDescriptor( EField.GX, 3 ),
                                                                           new ModeDescriptor( EField.GW, 10 ),
                                                                           new ModeDescriptor( EField.BZ, 0 ),
                                                                           new ModeDescriptor( EField.GZ, 0 ),
                                                                           new ModeDescriptor( EField.GZ, 1 ),
                                                                           new ModeDescriptor( EField.GZ, 2 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.BX, 2 ),
                                                                           new ModeDescriptor( EField.BX, 3 ),
                                                                           new ModeDescriptor( EField.BW, 10 ),
                                                                           new ModeDescriptor( EField.BZ, 1 ),
                                                                           new ModeDescriptor( EField.BY, 0 ),
                                                                           new ModeDescriptor( EField.BY, 1 ),
                                                                           new ModeDescriptor( EField.BY, 2 ),
                                                                       ...
                                                                       new List < ModeDescriptor >()
                                                                       {
                                                                           ...
                                                                           new ModeDescriptor( EField.RX, 4 ),
                                                                           new ModeDescriptor( EField.RX, 5 ),
                                                                           new ModeDescriptor( EField.RX, 6 ),
                                                                           new ModeDescriptor( EField.RX, 7 ),
                                                                           new ModeDescriptor( EField.RX, 8 ),
                                                                           new ModeDescriptor( EField.RX, 9 ),
                                                                           new ModeDescriptor( EField.GX, 0 ),
                                                                           new ModeDescriptor( EField.GX, 1 ),
                                                                           new ModeDescriptor( EField.GX, 2 ),
                                                                           new ModeDescriptor( EField.GX, 3 ),
                                                                           new ModeDescriptor( EField.GX, 4 ),
                                                                           new ModeDescriptor( EField.GX, 5 ),
                                                                           new ModeDescriptor( EField.GX, 6 ),
                                                                           new ModeDescriptor( EField.GX, 7 ),
                                                                           new ModeDescriptor( EField.GX, 8 ),
                                                                           new ModeDescriptor( EField.GX, 9 ),
                                                                           new ModeDescriptor( EField.BX, 0 ),
                                                                           new ModeDescriptor( EField.BX, 1 ),
                                                                           new ModeDescriptor( EField.BX, 2 ),
                                                                           new ModeDescriptor( EField.BX, 3 ),
                                                                           new ModeDescriptor( EField.BX, 4 ),
                                                                           new ModeDescriptor( EField.BX, 5 ),
                                                                           new ModeDescriptor( EField.BX, 6 ),
                                                                           new ModeDescriptor( EField.BX, 7 ),
                                                                           new ModeDescriptor( EField.BX, 8 ),
                                                                           new ModeDescriptor( EField.BX, 9 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
                                                                       ...
                                                                       new List < ModeDescriptor >()
                                                                       {
                                                                           ...
                                                                           new ModeDescriptor( EField.RX, 6 ),
                                                                           new ModeDescriptor( EField.RX, 7 ),
                                                                           new ModeDescriptor( EField.RW, 11 ),
                                                                           new ModeDescriptor( EField.RW, 10 ),
                                                                           new ModeDescriptor( EField.GX, 0 ),
                                                                           new ModeDescriptor( EField.GX, 1 ),
                                                                           new ModeDescriptor( EField.GX, 2 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.GX, 6 ),
                                                                           new ModeDescriptor( EField.GX, 7 ),
                                                                           new ModeDescriptor( EField.GW, 11 ),
                                                                           new ModeDescriptor( EField.GW, 10 ),
                                                                           new ModeDescriptor( EField.BX, 0 ),
                                                                           new ModeDescriptor( EField.BX, 1 ),
                                                                           new ModeDescriptor( EField.BX, 2 ),
                                                                           ...
                                                                           new ModeDescriptor( EField.BX, 6 ),
                                                                           new ModeDescriptor( EField.BX, 7 ),
                                                                           new ModeDescriptor( EField.BW, 11 ),
                                                                           new ModeDescriptor( EField.BW, 10 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
                                                                       ...
                                                                       new List < ModeDescriptor >()
                                                                       {
                                                                           ...
                                                                           new ModeDescriptor( EField.RX, 2 ),
                                                                           new ModeDescriptor( EField.RX, 3 ),
                                                                           new ModeDescriptor( EField.RW, 15 ),
                                                                           new ModeDescriptor( EField.RW, 14 ),
                                                                           new ModeDescriptor( EField.RW, 13 ),
                                                                           new ModeDescriptor( EField.RW, 12 ),
                                                                           new ModeDescriptor( EField.RW, 11 ),
                                                                           new ModeDescriptor( EField.RW, 10 ),
                                                                           new ModeDescriptor( EField.GX, 0 ),
                                                                           new ModeDescriptor( EField.GX, 1 ),
                                                                           new ModeDescriptor( EField.GX, 2 ),
                                                                           new ModeDescriptor( EField.GX, 3 ),
                                                                           new ModeDescriptor( EField.GW, 15 ),
                                                                           new ModeDescriptor( EField.GW, 14 ),
                                                                           new ModeDescriptor( EField.GW, 13 ),
                                                                           new ModeDescriptor( EField.GW, 12 ),
                                                                           new ModeDescriptor( EField.GW, 11 ),
                                                                           new ModeDescriptor( EField.GW, 10 ),
                                                                           new ModeDescriptor( EField.BX, 0 ),
                                                                           new ModeDescriptor( EField.BX, 1 ),
                                                                           new ModeDescriptor( EField.BX, 2 ),
                                                                           new ModeDescriptor( EField.BX, 3 ),
                                                                           new ModeDescriptor( EField.BW, 15 ),
                                                                           new ModeDescriptor( EField.BW, 14 ),
                                                                           new ModeDescriptor( EField.BW, 13 ),
                                                                           new ModeDescriptor( EField.BW, 12 ),
                                                                           new ModeDescriptor( EField.BW, 11 ),
                                                                           new ModeDescriptor( EField.BW, 10 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
                                                                           new ModeDescriptor( EField.NA, 0 ),
        ...
        private static ModeInfo[] ms_aInfo = new ModeInfo[]
                                             {
                                                 new ModeInfo(
                                                              0,
                                                              0x00,
                                                 ...
                                                 new ModeInfo(
                                                              ...
                                                              new LDRColour[]
                                                              {
                                                                  new LDRColour( 11, 11, 11, 0 ),
                                                                  new LDRColour( 5, 4, 4, 0 )
                                                              },
                                                              new LDRColour[]
                                                              {
                                                                  new LDRColour( 5, 4, 4, 0 ),
        ...
        private const int BC6H_MAX_REGIONS = 2;
        private const ushort HALF_FLOAT_MASK = 32768;
        private const int BC6H_MAX_SHAPES = 32;
        private const int BC6H_MAX_INDICIES = 16;

        private const int F16MIN = -31743;
        private const ushort F16MAX = 31743;
        ...
        internal static void CompressBC6Block(
            ...
            byte[] destination,
            int destStart,
            INTColour[] overrides = null,
            RGBColour[] overrides2 = null )
        {
            int modeVal = 0;
            ...
            else
            {
                for ( int i = 0; i < 4; i++ )
                {
                    for ( int j = 0; j < 4; j++ )
                    {
                        int offset = sourceStart + i * sourceLineLength + j * 4; // TODO Component sizes

                        byte r = source[offset + 2]; // Red
                        byte g = source[offset + 1]; // Green
                        byte b = source[offset];     // Blue
                        byte a = source[offset + 3]; // Alpha

                        Color c = new Color( r / 255f, g / 255f, b / 255f, a / 255f );
                        RGBColour pixel = new RGBColour( c.r, c.g, c.b, c.a );
                        pixels[i * 4 + j] = pixel;
            ...
            for ( modeVal = 0; modeVal < ms_aInfo.Length && bestErr > 0; modeVal++ )
            {
                ...
                {
                    roughMSEs[shape] = RoughMSE(
                                                ref AllEndPoints[shape],
                                                mode,
                                                shape,
                                                block,
                                                pixels,
            ...
            if ( ModeToInfo[mode] >= 0 )
            {
                ...
                while ( startBit < headerBits )
                {
                    ...
                    if ( GetBit( source, sourceStart, ref startBit ) != 0 )
                    {
                        ...
                        {
                            case EField.D:
                                shape |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.RW:
                                endPoints[0].A.R |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.RX:
                                endPoints[0].B.R |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.RY:
                                endPoints[1].A.R |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.RZ:
                                endPoints[1].B.R |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.GW:
                                endPoints[0].A.G |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.GX:
                                endPoints[0].B.G |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.GY:
                                endPoints[1].A.G |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.GZ:
                                endPoints[1].B.G |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.BW:
                                endPoints[0].A.B |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.BX:
                                endPoints[0].B.B |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.BY:
                                endPoints[1].A.B |= 1 << desc[currBit].m_uBit;

                                break;

                            case EField.BZ:
                                endPoints[1].B.B |= 1 << desc[currBit].m_uBit;
                ...
                for ( int i = 0; i < NUM_PIXELS_PER_BLOCK; i++ )
                {
                    ...
                    INTColour fc = new INTColour()
                                   {
                                       R = FinishUnquantise(
                                                            ( r1 * ( BC67_WEIGHT_MAX - aWeights[index] ) +
                                                              r2 * aWeights[index] +
                                                              BC67_WEIGHT_ROUND ) >>
                                                            BC67_WEIGHT_SHIFT,
                                                            isSigned
                                       ...
                                       G = FinishUnquantise(
                                                            ( g1 * ( BC67_WEIGHT_MAX - aWeights[index] ) +
                                                              g2 * aWeights[index] +
                                                              BC67_WEIGHT_ROUND ) >>
                                                            BC67_WEIGHT_SHIFT,
                                                            isSigned
                                       ...
                                       B = FinishUnquantise(
                                                            ( b1 * ( BC67_WEIGHT_MAX - aWeights[index] ) +
                                                              b2 * aWeights[index] +
                                                              BC67_WEIGHT_ROUND ) >>
                                                            BC67_WEIGHT_SHIFT,
                                                            isSigned
        ...
        private static void AssignIndicies(
            ModeInfo mode,
            INTColourPair[] endPts,
            float[] totalErr,
            int shape,
            INTColour[] block,
            int[] pixelIndicies )
                ...
                switch ( desc[startBit].eField )
                {
                    ...
                    case EField.RW:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[0].A.R >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.RX:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[0].B.R >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.RY:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[1].A.R >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.RZ:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[1].B.R >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.GW:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[0].A.G >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.GX:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[0].B.G >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.GY:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[1].A.G >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.GZ:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[1].B.G >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.BW:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[0].A.B >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.BX:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[0].B.B >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.BY:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[1].A.B >> desc[startBit].m_uBit ) & 0x01
                              );
                    ...
                    case EField.BZ:
                        SetBit(
                               ...
                               destination,
                               destStart,
                               ( endPts[1].B.B >> desc[startBit].m_uBit ) & 0x01
                              );
        ...
        private static bool EndPointsFit( ModeInfo mode, INTColourPair[] endPts )
        {
            bool isSigned = false; // TODO signed

            LDRColour prec0 = mode.RGBAPrec[0][0];
            LDRColour prec1 = mode.RGBAPrec[0][1];
            LDRColour prec2 = mode.RGBAPrec[1][0];
            LDRColour prec3 = mode.RGBAPrec[1][1];
        ...
        private static void GeneratePaletteQuantised( ModeInfo mode, INTColourPair endPoints, INTColour[] palette )
        {
            bool isSigned = false; // TODO signed

            int numIndicies = 1 << mode.IndexPrecision;
            LDRColour prec = mode.RGBAPrec[0][0];
            ...
            {
                palette[i].R = FinishUnquantise(
                                                ( unqEndPts.A.R * ( BC67_WEIGHT_MAX - weights[i] ) +
                                                  unqEndPts.B.R * weights[i] +
                                                  BC67_WEIGHT_ROUND ) >>
                                                BC67_WEIGHT_SHIFT,
                                                isSigned
                                               );

                palette[i].G = FinishUnquantise(
                                                ( unqEndPts.A.G * ( BC67_WEIGHT_MAX - weights[i] ) +
                                                  unqEndPts.B.G * weights[i] +
                                                  BC67_WEIGHT_ROUND ) >>
                                                BC67_WEIGHT_SHIFT,
                                                isSigned
                                               );

                palette[i].B = FinishUnquantise(
                                                ( unqEndPts.A.B * ( BC67_WEIGHT_MAX - weights[i] ) +
                                                  unqEndPts.B.B * weights[i] +
                                                  BC67_WEIGHT_ROUND ) >>
                                                BC67_WEIGHT_SHIFT,
                                                isSigned
                                               );
        ...
        private static void GeneratePaletteUnquantised(
            INTColourPair endPoints,
            int indexPrecision,
            INTColour[] palette )
        {
            ...
            for ( int i = 0; i < numIndicies; i++ )
            {
                ...
                {
                    palette[i].R =
                        ( endPoints.A.R * ( BC67_WEIGHT_MAX - weights[i] ) +
                          endPoints.B.R * weights[i] +
                          BC67_WEIGHT_ROUND ) >>
                        BC67_WEIGHT_SHIFT;

                    palette[i].G =
                        ( endPoints.A.G * ( BC67_WEIGHT_MAX - weights[i] ) +
                          endPoints.B.G * weights[i] +
                          BC67_WEIGHT_ROUND ) >>
                        BC67_WEIGHT_SHIFT;

                    palette[i].B =
                        ( endPoints.A.B * ( BC67_WEIGHT_MAX - weights[i] ) +
                          endPoints.B.B * weights[i] +
                          BC67_WEIGHT_ROUND ) >>
                        BC67_WEIGHT_SHIFT;
                }
            }
        ...
        private static float MapColours(
            ModeInfo mode,
            int np,
            int region,
            INTColourPair endPoints,
        ...
        private static float MapColoursQuantised( ModeInfo mode, INTColourPair endPts, int np, INTColour[] block )
        {
            int numIndicies = 1 << mode.IndexPrecision;
            ...
            for ( int i = 0; i < np; i++ )
            {
                int rDiff = block[i].R - palette[0].R;
                int gDiff = block[i].G - palette[0].G;
                int bDiff = block[i].B - palette[0].B;
        ...
        private static float Norm( INTColour a, INTColour b )
        {
            float dr = a.R - b.R;
            float dg = a.G - b.G;
            float db = a.B - b.B;
        ...
        private static void OptimiseEndPoints(
            ModeInfo mode,
            int shape,
            INTColour[] block,
            float[] orgErr,
            INTColourPair[] optEndPts,
            INTColourPair[] orgEndPts )
        {
        ...
        private static unsafe void OptimiseOne(
            ModeInfo mode,
            float orgErr,
            ref INTColourPair opt,
            INTColourPair orgEndPts,
            int np,
            INTColour[] block )
        {
        ...
        private static unsafe float PerturbOne(
            ModeInfo mode,
            int ch,
            float oldErr,
            ref INTColourPair olds,
            ref INTColourPair news,
            bool do_b,
            INTColour[] block,
            int np )
        {
        ...
        private static void QuantiseEndPts(
            ModeInfo mode,
            INTColourPair[] quantisedEndPts,
            INTColourPair[] unqantisedEndPts )
        {
            bool isSigned = false;
        ...
        private static float RoughMSE(
            ref INTColourPair[] endPoints,
            ModeInfo mode,
            int shape,
            INTColour[] block,
            RGBColour[] pixels,
        ...
        private static void SetBit( ref int startBit, byte[] destination, int destStart, int bit )
        {
        ...
        private static void SetBits( ref int startBit, int length, int value, byte[] destination, int destStart )
        {
            if ( length == 0 )
            {
                return;
        ...
        private static INTColour SignExtend( INTColour c, LDRColour prec )
        {
            return new INTColour()
                   {
        ...
        private static int SignExtend( int colour, int precision )
        {
            return ( ( colour & ( 1 << ( precision - 1 ) ) ) != 0 ? ~0 << precision : 0 ) | colour;
        }

        private static void SwapIndicies( ModeInfo mode, int shape, int[] pixelIndicies, INTColourPair[] endPts )
        {
            int numIndicies = 1 << mode.IndexPrecision;
        ...
        private static void TransformForward( INTColourPair[] endPts )
        {
