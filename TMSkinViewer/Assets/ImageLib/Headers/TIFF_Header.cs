...
namespace CSharpImageLibrary.Headers
{
    ...
    public class TIFF_Header : AbstractHeader
    {
        ...
        ///     Essentially a mipmap header, except these "mipmaps" have no restrictions i.e. They don't have to be related to the
        ///     first image at all e.g. scanned pages from a scanner.
        /// </summary>
        public struct ImageFileDirectory
        {
            ...
            public struct FieldDescriptor
            {
                ...
                public enum FieldTags
                {
                    ...
                    /// <summary>
                    ///     General indication of what kind of data this subfile is. Full res data, reduced res data, single page of multi page
                    ///     image.
                    /// </summary>
                    SubFileType = 0xFF,
                    ...
                    /// <summary>
                    ///     Indicates type of colour style. Continous tone (natural image), synthetic image (greatly restricted colour range,
                    ///     see ColourList)
                    /// </summary>
        ...
        private MyBitConverter.Endianness endianness = MyBitConverter.Endianness.LittleEndian;

        /// <summary>
        ///     Format of image.
        /// </summary>
        public override ImageEngineFormat Format => ImageEngineFormat.TIF;
        ...
        /// </summary>
        public int NumMipMaps => Pages?.Count ?? -1;
        ...
        protected override long Load( Stream stream )
        {
            ...
            ImageFileDirectory IFD = new ImageFileDirectory( stream, endianness );
