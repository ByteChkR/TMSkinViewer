...
//         internal static List < MipMap > LoadWithCodecs(
//             string imageFile,
//             int decodeWidth,
//             int decodeHeight,
//             double scale,
...
//                 }
//
//                 foreach ( BitmapFrame mipmap in decoder.Frames )
//                 {
...
//         {
//             WriteableBitmap image = Images.CreateWriteableBitmap( imageData, width, height );
//             image.Freeze();
...
//                                                new FormatConvertedBitmap( image, PixelFormats.Bgr32, image.Palette, 0 )
//                                               );
//                 }
//             }
//             else
...
//                                                         $"Unable to encode format: {format} using Windows 8.1 Codecs."
//                                                        );
//             }
//
...
//             try
//             {
//                 img = Images.CreateWPFBitmap( imagePath, decodeWidth, decodeHeight );
//             }
...
//             try
//             {
//                 img = Images.CreateWPFBitmap( ImageFileData, decodeWidth, decodeHeight );
//             }
//             catch ( FileFormatException fileformatexception )
//             {
//                 Debug.WriteLine( fileformatexception );
...
//             try
//             {
//                 img = Images.CreateWPFBitmap( stream, decodeWidth, decodeHeight );
//             }
//             catch ( FileFormatException fileformatexception )
//             {
//                 Debug.WriteLine( fileformatexception );
