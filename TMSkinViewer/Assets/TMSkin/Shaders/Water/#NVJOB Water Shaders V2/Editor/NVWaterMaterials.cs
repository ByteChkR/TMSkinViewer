...
internal class NVWaterMaterials : MaterialEditor
{
    ...
    private void Albedo( List < MaterialProperty > allProps )
    {
        //--------------
        ...
        IEnumerable < bool > enableAlbedoTex2 =
            targets.Select( t => ( ( Material )t ).shaderKeywords.Contains( "EFFECT_ALBEDO2" ) );
        ...
        if ( enableAlbedoTex2 != null && albedoTex2 != null && albedo2Tiling != null && albedo2Flow != null )
        {
            ...
            if ( enable != null )
            {
                foreach ( Material m in targets.Cast < Material >() )
                {
                    if ( enable.Value )
                    {
                        m.EnableKeyword( "EFFECT_ALBEDO2" );
                    }
                    else
                    {
                        m.DisableKeyword( "EFFECT_ALBEDO2" );
                    }
                }
            }
    ...
    private void NormalMaps( List < MaterialProperty > allProps )
    {
        //--------------
        ...
        IEnumerable < bool > enableNormalMap2 =
            targets.Select( t => ( ( Material )t ).shaderKeywords.Contains( "EFFECT_NORMALMAP2" ) );

        if ( enableNormalMap2 != null &&
             normalMap2 != null &&
             normalMap2Tiling != null &&
             normalMap2Strength != null &&
             normalMap2Flow != null )
        {
            ...
            if ( enable != null )
            {
                foreach ( Material m in targets.Cast < Material >() )
                {
                    if ( enable.Value )
                    {
                        m.EnableKeyword( "EFFECT_NORMALMAP2" );
                    }
                    else
                    {
                        m.DisableKeyword( "EFFECT_NORMALMAP2" );
                    }
                }
            }
        ...
        if ( enableNormalMap2 != null && enableNormalMap2.First() )
        {
            ...
            IEnumerable < bool > enableMicrowave =
                targets.Select( t => ( ( Material )t ).shaderKeywords.Contains( "EFFECT_MICROWAVE" ) );
            ...
            if ( enableMicrowave != null && microwaveScale != null && microwaveStrength != null )
            {
                ...
                if ( enable != null )
                {
                    foreach ( Material m in targets.Cast < Material >() )
                    {
                        if ( enable.Value )
                        {
                            m.EnableKeyword( "EFFECT_MICROWAVE" );
                        }
                        else
                        {
                            m.DisableKeyword( "EFFECT_MICROWAVE" );
                        }
                    }
                }
    ...
    private void Parallax( List < MaterialProperty > allProps )
    {
        //--------------
        ...
        IEnumerable < bool > enableParallax =
            targets.Select( t => ( ( Material )t ).shaderKeywords.Contains( "EFFECT_PARALLAX" ) );

        if ( enableParallax != null &&
             parallaxAmount != null &&
             parallaxFlow != null &&
             parallaxNormal2Offset != null &&
             parallaxNoiseGain != null &&
             parallaxNoiseAmplitude != null &&
             parallaxNoiseFrequency != null &&
             parallaxNoiseScale != null &&
             parallaxNoiseLacunarity != null )
        {
            ...
            if ( enable != null )
            {
                foreach ( Material m in targets.Cast < Material >() )
                {
                    if ( enable.Value )
                    {
                        m.EnableKeyword( "EFFECT_PARALLAX" );
                    }
                    else
                    {
                        m.DisableKeyword( "EFFECT_PARALLAX" );
                    }
                }
            }
    ...
    private void Reflection( List < MaterialProperty > allProps )
    {
        if ( allProps.Find( prop => prop.name == "_ReflectionCube" ) != null )
        {
            ...
            IEnumerable < bool > enableReflectionCube =
                targets.Select( t => ( ( Material )t ).shaderKeywords.Contains( "EFFECT_REFLECTION" ) );

            if ( enableReflectionCube != null &&
                 reflectionCube != null &&
                 reflectionColor != null &&
                 reflectionStrength != null &&
                 reflectionSaturation != null &&
                 reflectionContrast != null )
            {
                ...
                if ( enable != null )
                {
                    foreach ( Material m in targets.Cast < Material >() )
                    {
                        if ( enable.Value )
                        {
                            m.EnableKeyword( "EFFECT_REFLECTION" );
                        }
                        else
                        {
                            m.DisableKeyword( "EFFECT_REFLECTION" );
                        }
                    }
                }
    ...
    private void MirrorReflection( List < MaterialProperty > allProps )
    {
        //--------------
        ...
        IEnumerable < bool > enableMirrorReflection =
            targets.Select( t => ( ( Material )t ).shaderKeywords.Contains( "EFFECT_MIRROR" ) );

        if ( enableMirrorReflection != null &&
             mirrorColor != null &&
             mirrorDepthColor != null &&
             mirrorFPOW != null &&
             mirrorR0 != null &&
             mirrorStrength != null &&
             mirrorSaturation != null &&
             mirrorContrast != null &&
             mirrorWavePow != null &&
             mirrorWaveScale != null &&
             mirrorWaveFlow != null )
        {
            ...
            if ( enable != null )
            {
                foreach ( Material m in targets.Cast < Material >() )
                {
                    if ( enable.Value )
                    {
                        m.EnableKeyword( "EFFECT_MIRROR" );
                    }
                    else
                    {
                        m.DisableKeyword( "EFFECT_MIRROR" );
                    }
                }
            }
    ...
    private void Foam( List < MaterialProperty > allProps )
    {
        //--------------
        ...
        IEnumerable < bool > enableFoam =
            targets.Select( t => ( ( Material )t ).shaderKeywords.Contains( "EFFECT_FOAM" ) );
             ...
             foamSoft != null )
        {
            ...
            if ( enable != null )
            {
                foreach ( Material m in targets.Cast < Material >() )
                {
                    if ( enable.Value )
                    {
                        m.EnableKeyword( "EFFECT_FOAM" );
                    }
                    else
                    {
                        m.DisableKeyword( "EFFECT_FOAM" );
                    }
                }
            }
    ...
    public static void Information()
    {
        ...
        {
            Help.BrowseURL( "https://nvjob.github.io/unity/nvjob-water-shaders-v2" );
        }
        ...
        if ( GUILayout.Button( "Support this asset" ) )
        {
            Help.BrowseURL( "https://www.paypal.com/paypalme/nvjob/5usd" );
        }
