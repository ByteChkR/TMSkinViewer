...
namespace UI.Settings
{
        ...
        where T : Object
    {
        ...
        protected override void OnResourceSelected( ResourceNode resource )
        {
            OnResourceSelected( ( T )resource.GetResource(), resource );
        }
            ...
            m_Button.onClick.AddListener(
                                         () =>
                                         {
                                             ResourceSelectorWindow window =
                                                 ResourceSelectorWindowBuilder.CreateWindow( prop.Type );
