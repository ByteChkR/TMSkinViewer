...
public class BasicSample : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        Vector3 guiScale = new Vector3( Screen.width / 800.0f, Screen.height / 600.0f, 1.0f );
        ...
        if ( GUILayout.Button( "Open File Async" ) )
        {
            StandaloneFileBrowser.OpenFilePanelAsync(
                                                     ...
                                                     "",
                                                     false,
                                                     ( string[] paths ) => { WriteResult( paths ); }
                                                    );
        }
        ...
        {
            string[] paths = StandaloneFileBrowser.OpenFolderPanel( "Select Folder", Application.dataPath, true );
            WriteResult( paths );
        }
